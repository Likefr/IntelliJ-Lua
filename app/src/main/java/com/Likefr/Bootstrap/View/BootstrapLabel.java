...
import com.Likefr.Bootstrap.View.api.defaults.DefaultBootstrapHeading;
import com.Likefr.Bootstrap.View.api.view.BootstrapHeadingView;
...
public class BootstrapLabel extends AwesomeTextView implements RoundableView, BootstrapHeadingView {
    ...
    private static final String TAG = "com.Likefr.Bootstrap.View.BootstrapLabel";
