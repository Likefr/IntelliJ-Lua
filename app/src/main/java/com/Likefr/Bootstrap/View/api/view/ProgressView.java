...
public interface ProgressView {
    ...
    String KEY_USER_PROGRESS = "com.Likefr.Bootstrap.View.api.view.KEY_USER_PROGRESS";
    String KEY_DRAWN_PROGRESS = "com.Likefr.Bootstrap.View.api.view.KEY_DRAWN_PROGRESS";
    String KEY_STRIPED = "com.Likefr.Bootstrap.View.api.view.KEY_STRIPED";
    String KEY_ANIMATED = "com.Likefr.Bootstrap.View.api.view.KEY_ANIMATED";
