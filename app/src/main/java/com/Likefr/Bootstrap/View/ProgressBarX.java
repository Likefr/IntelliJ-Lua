...
import com.Likefr.Bootstrap.View.api.view.ProgressView;
 ...
 *
 * Its possible to group multiple together in an {@link BootstrapProgressBarGroup BootstrapProgressBarGroup} to give the appearance of a <a href="http://getbootstrap.com/components/#progress-stacked">stacked</a> progressbar.
 */
public class ProgressBarX extends View implements ProgressView, BootstrapBrandView,
        RoundableView, BootstrapSizeView, Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {

    private static final String TAG = "com.Likefr.Bootstrap.View.AwesomeTextView";
    ...
    public ProgressBarX(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialise(attrs);
    }

    public ProgressBarX(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initialise(AttributeSet attrs) {
        ...
        // get attributes
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ProgressBarX);

        try {
            this.animated = a.getBoolean(R.styleable.ProgressBarX_animated, false);
            this.rounded = a.getBoolean(R.styleable.ProgressBarX_roundedCorners, false);
            this.striped = a.getBoolean(R.styleable.ProgressBarX_striped, false);
            this.showPercentage = a.getBoolean(R.styleable.ProgressBarX_bootstrapshowPercentage, false);
            this.userProgress = a.getInt(R.styleable.ProgressBarX_bootstrapProgress, 0);
            this.maxProgress = a.getInt(R.styleable.ProgressBarX_bootstrapMaxProgress, 100);

            int typeOrdinal = a.getInt(R.styleable.ProgressBarX_bootstrapBrand, -1);
            int sizeOrdinal = a.getInt(R.styleable.ProgressBarX_bootstrapSize, -1);
