...
import com.Likefr.Bootstrap.View.api.defaults.ExpandDirection;
import com.Likefr.Bootstrap.View.api.view.BootstrapSizeView;
import com.Likefr.Bootstrap.View.api.view.OutlineableView;
...
import com.Likefr.Bootstrap.View.utils.DrawableUtils;
...
public class BootstrapDropDown extends AwesomeTextView implements View.OnClickListener, RoundableView, OutlineableView, PopupWindow.OnDismissListener {
    ...
    private static final String TAG = "com.Likefr.Bootstrap.View.BootstrapDropDown";
    private static final String KEY_DIRECTION = "com.Likefr.Bootstrap.View.BootstrapDropDown.EXPAND_DIRECTION";
