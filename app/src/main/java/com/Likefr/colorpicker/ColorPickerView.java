package com.Likefr.colorpicker;
...
import com.Likefr.colorpicker.builder.ColorWheelRendererBuilder;
import com.Likefr.colorpicker.builder.PaintBuilder;
import com.Likefr.colorpicker.renderer.ColorWheelRenderOption;
import com.Likefr.colorpicker.renderer.ColorWheelRenderer;
import com.Likefr.colorpicker.slider.AlphaSlider;
import com.Likefr.colorpicker.slider.LightnessSlider;
...
public class ColorPickerView extends View {
	...
	private com.Likefr.colorpicker.ColorCircle currentColorCircle;

	private ArrayList<com.Likefr.colorpicker.OnColorChangedListener> colorChangedListeners = new ArrayList<>();
	private ArrayList<com.Likefr.colorpicker.OnColorSelectedListener> listeners = new ArrayList<>();
	...
	public boolean onTouchEvent(MotionEvent event) {
		switch (event.getAction()) {
			...
			case MotionEvent.ACTION_UP: {
				int selectedColor = getSelectedColor();
				if (listeners != null) {
					for (com.Likefr.colorpicker.OnColorSelectedListener listener : listeners) {
						try {
	...
	protected void callOnColorChangedListeners(int oldColor, int newColor) {
		if (colorChangedListeners != null && oldColor != newColor) {
			for (com.Likefr.colorpicker.OnColorChangedListener listener : colorChangedListeners) {
				try {
	...
	private com.Likefr.colorpicker.ColorCircle findNearestByPosition(float x, float y) {
		com.Likefr.colorpicker.ColorCircle near = null;
		double minDist = Double.MAX_VALUE;

		for (com.Likefr.colorpicker.ColorCircle colorCircle : renderer.getColorCircleList()) {
	...
	private com.Likefr.colorpicker.ColorCircle findNearestByColor(int color) {
	...
	public int getSelectedColor() {
		...
		if (currentColorCircle != null)
			color = com.Likefr.colorpicker.Utils.colorAtLightness(currentColorCircle.getColor(), this.lightness);
		return com.Likefr.colorpicker.Utils.adjustAlpha(this.alpha, color);
	}
	...
	public void setInitialColor(int color, boolean updateText) {
		...
		this.alpha = com.Likefr.colorpicker.Utils.getAlphaPercent(color);
	...
	public void setLightness(float lightness) {
		...
		if (currentColorCircle != null) {
            this.initialColor = Color.HSVToColor(com.Likefr.colorpicker.Utils.alphaValueAsInt(this.alpha), currentColorCircle.getHsvWithLightness(lightness));
            if (this.colorEdit != null)
                this.colorEdit.setText(com.Likefr.colorpicker.Utils.getHexString(this.initialColor, this.alphaSlider != null));
	...
	public void setAlphaValue(float alpha) {
		...
		this.alpha = alpha;
		this.initialColor = Color.HSVToColor(com.Likefr.colorpicker.Utils.alphaValueAsInt(this.alpha), currentColorCircle.getHsvWithLightness(this.lightness));
		if (this.colorEdit != null)
			this.colorEdit.setText(com.Likefr.colorpicker.Utils.getHexString(this.initialColor, this.alphaSlider != null));
	...
	public void addOnColorChangedListener(com.Likefr.colorpicker.OnColorChangedListener listener) {
		this.colorChangedListeners.add(listener);
	}

	public void addOnColorSelectedListener(com.Likefr.colorpicker.OnColorSelectedListener listener) {
	...
	private void setColorPreviewColor(int newColor) {
		...
		LinearLayout childLayout = (LinearLayout) childView;
		ImageView childImage = (ImageView) childLayout.findViewById(R.id.image_preview);
		childImage.setImageDrawable(new com.Likefr.colorpicker.ColorCircleDrawable(newColor));
	}

	private void setColorText(int argb) {
		if (colorEdit == null)
			return;
		colorEdit.setText(com.Likefr.colorpicker.Utils.getHexString(argb, this.alphaSlider != null));
	}
