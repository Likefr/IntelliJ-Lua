...
import com.Likefr.colorpicker.builder.ColorPickerDialogBuilder;
import com.Likefr.colorpicker.builder.ColorPickerClickListener;
...
public class ColorPickerPreference extends Preference {
	...
	protected com.Likefr.colorpicker.ColorPickerView.WHEEL_TYPE wheelType;
	...
	private void initWith(Context context, AttributeSet attrs) {
		...
		try {
			...
			wheelType = com.Likefr.colorpicker.ColorPickerView.WHEEL_TYPE.indexOf(typedArray.getInt(R.styleable.ColorPickerPreference_wheelType, 0));
	...
	protected void onBindView(@NonNull View view) {
		...
		com.Likefr.colorpicker.ColorCircleDrawable colorChoiceDrawable = null;
		Drawable currentDrawable = colorIndicator.getDrawable();
		if (currentDrawable != null && currentDrawable instanceof com.Likefr.colorpicker.ColorCircleDrawable)
			colorChoiceDrawable = (com.Likefr.colorpicker.ColorCircleDrawable) currentDrawable;

		if (colorChoiceDrawable == null)
			colorChoiceDrawable = new com.Likefr.colorpicker.ColorCircleDrawable(tmpColor);
