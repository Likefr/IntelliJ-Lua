...
public class LanguageLua extends Language {
	...
	//自定义关键字
	private final static String keyNamea="";
	private final static String keyNameb="";
	private final static String keyNamec="";
	private final static String keyNamed="";
	private final static String keyNamee="";
	private final static String keyNamef="";
	private final static String keyNameg="";
	private final static String keyNameh="";
	private final static String keyNamei="";
	private final static String keyNamej="";
	private final static String keyNamek="";
	private final static String keyNamel="";
	private final static String keyNamem="";
	private final static String keyNamen="";
	private final static String keyNameo="";
	private final static String keyNamep="";
	private final static String keyNameq="";
	private final static String keyNamer="";
	private final static String keyNames="";
	private final static String keyNamet="";
	
	private final static String[] namesa = keyNamea.split("\\|");
	private final static String[] namesb = keyNameb.split("\\|");
	private final static String[] namesc = keyNamec.split("\\|");
	private final static String[] namesd = keyNamed.split("\\|");
	private final static String[] namese = keyNamee.split("\\|");
	private final static String[] namesf = keyNamef.split("\\|");
	private final static String[] namesg = keyNameg.split("\\|");
	private final static String[] namesh = keyNameh.split("\\|");
	private final static String[] namesi = keyNamei.split("\\|");
	private final static String[] namesj = keyNamej.split("\\|");
	private final static String[] namesk = keyNamek.split("\\|");
	private final static String[] namesl = keyNamel.split("\\|");
	private final static String[] namesm = keyNamem.split("\\|");
	private final static String[] namesn = keyNamen.split("\\|");
	private final static String[] nameso = keyNameo.split("\\|");
	private final static String[] namesp = keyNamep.split("\\|");
	private final static String[] namesq = keyNameq.split("\\|");
	private final static String[] namesr = keyNamer.split("\\|");
	private final static String[] namess = keyNames.split("\\|");
	private final static String[] namest = keyNamet.split("\\|");
