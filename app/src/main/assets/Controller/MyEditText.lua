...
local function MyEditTextOpenAnim(view,TextHintSize,editH,time)
  local animationSet=AnimationSet(true)
  animationSet.addAnimation(TranslateAnimation(0,0,editH,0).setDuration(time or 150))
  view.startAnimation(animationSet.setFillAfter(true))
  local animationSet=AnimationSet(true)
  animationSet.addAnimation(ScaleAnimation(TextHintSize(),1,TextHintSize(),1).setDuration(time or 150))
...
local function MyEditTextCloseAnim(view,TextHintSize,editH)
  local animationSet=AnimationSet(true)
  animationSet.addAnimation(TranslateAnimation(0,0,0,editH).setDuration(time or 150))
  view.startAnimation(animationSet.setFillAfter(true))

  local animationSet=AnimationSet(true)
  animationSet.addAnimation(ScaleAnimation(1,TextHintSize(),1,TextHintSize()).setDuration(time or 150))
  view.getChildAt(0).startAnimation(animationSet.setFillAfter(true))
end
...
function MyEditText(info)
  ...
  MyEditTextCloseAnim(lay.getChildAt(0).getChildAt(2),TextHintSize,editH,0)
  ...
  if localid.EditText.text~="" then
    MyEditTextOpenAnim(lay.getChildAt(0).getChildAt(2),TextHintSize,editH,0)
  end
